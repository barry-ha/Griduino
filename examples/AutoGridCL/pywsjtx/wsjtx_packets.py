...
class PacketWriter(object):
    ...
    #bwh def write_QColor(self, color_val):
        ...
        #
    #bwh    self.write_QInt8(color_val.spec)
    #bwh    self.write_QUInt8(color_val.alpha)
    #bwh    self.write_QUInt8(color_val.alpha)

    #bwh    self.write_QUInt8(color_val.red)
    #bwh    self.write_QUInt8(color_val.red)

    #bwh    self.write_QUInt8(color_val.green)
    #bwh    self.write_QUInt8(color_val.green)

    #bwh    self.write_QUInt8(color_val.blue)
    #bwh    self.write_QUInt8(color_val.blue)
    #bwh    self.write_QUInt16(0)
...
#bwh class HighlightCallsignPacket(GenericWSJTXPacket):
#bwh     TYPE_VALUE = 13
#bwh     def __init__(self, addr_port, magic, schema, pkt_type, id, pkt):
#bwh         GenericWSJTXPacket.__init__(self, addr_port, magic, schema, pkt_type, id, pkt)
#bwh         # handle packet-specific stuff.

#bwh     # the callsign field can contain text, callsigns, entire lines.

#bwh     @classmethod
#bwh     def Builder(cls, to_wsjtx_id='WSJT-X', callsign="K1JT", background_color=None, foreground_color=None, highlight_last_only=True ):
#bwh         # build the packet to send
#bwh         pkt = PacketWriter()
#bwh         pkt.write_QInt32(HighlightCallsignPacket.TYPE_VALUE)
#bwh         pkt.write_QString(to_wsjtx_id)
#bwh         pkt.write_QString(callsign)
#bwh         pkt.write_QColor(background_color)
#bwh         pkt.write_QColor(foreground_color)
#bwh         pkt.write_QBool(highlight_last_only)
#bwh         return pkt.packet
