...
void initTestSineWave() {
  ...
  for (int ii = 0; ii < numTestData; ii++) {
    ...
    Serial.print(") at ");
    Serial.print(year(fakeTime));
    Serial.print("-");
    Serial.print(month(fakeTime));
    Serial.print("-");
    Serial.print(day(fakeTime));
    Serial.print("  ");
    Serial.print(hour(fakeTime));
    Serial.print(":");
    Serial.print(minute(fakeTime));
    Serial.print(":");
    Serial.print(second(fakeTime));
    Serial.print(" ");
    Serial.println("");
  }
}
...
void adjustUnits() {
  ...
  switch (gUnits) {
  case eEnglish:
    Serial.print("Units changed to English: ");
    Serial.println(gUnits);
    txtReading[unitPressure].print(sInchesHg);
    break;
  case eMetric:
    Serial.print("Units changed to Metric: ");
    Serial.println(gUnits);
  ...
  Serial.print(". unitPressure = ");
  Serial.println(txtReading[unitPressure].text);
...
int loadConfigUnits() {
  ...
  if (result) {
    ...
    Serial.print(". Loaded units setting: ");
    Serial.println(tempUnitSetting);
  }
  return result;
}
