...
//
// Date: 2024-12-12
// Modified: Barry Hansen, barry@k7bwh.com
// These files are ported from Adafruit example SdFat_format:
//      ff_diskio.h     is a minimally-changed copy of  diskio.h
//      ff.c            is a minimally-changed copy of  ff.c
//      ff.h            is a minimally-changed copy of  ff.h
//      ffconf.h        is a minimally-changed copy of  ffconf.h
//      flash_config.h  is a minimally-changed copy of  flash_config.h
//      format_SdFat.h  is a minimally-changed copy of  SdFat_format.ino
//      flash_config.h  is a minimally-changed copy of  flash_config.h
//      
//
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
void check_fat12(void) {
  ...
  if (!fatfs.begin(&flash)) {
    ...
    delay(3000);    // bwh: instead of while (1) delay(1);
  }
}


void setup_format() {       // bwh, was setup()
