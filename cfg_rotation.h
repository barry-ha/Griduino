...
// ========== class ViewSettings6 ==============================
class ViewSettings6 : public View {
  public:
    // ---------- public interface ----------
    // This derived class must implement the public interface:
    ViewSettings6(Adafruit_ILI9341* vtft, int vid)  // ctor 
      : View{ vtft, vid }
    {
...
};  // end class ViewSettings6

// ============== implement public interface ================
void ViewSettings6::updateScreen() {
...
void ViewSettings6::startScreen() {
...
bool ViewSettings6::onTouch(Point touch) {
